    ...
    <>
      <div className='w-full  flex justify-between items-center font-semibold'>
        <div className='flex item-center gap-2'>
          <img className='w-8 bg-black rounded-2x1 cursor-pointer' src={assets.arrow_left} alt=''></img>
          <img className='w-8 bg-black rounded-2x1 cursor-pointer' src={assets.arrow_right} alt=''></img>
